...
def render_bio(name, gender, prof_lemma, nat_lemma, config):
    ...
    def apply_suffix(stem, suffix_data):
        ...
        variants = suffix_data.get('variants', {}) if isinstance(suffix_data, dict) else {'default': suffix_data}
        ...
        deletion_rules = suffix_data.get('deletion', []) if isinstance(suffix_data, dict) else []
