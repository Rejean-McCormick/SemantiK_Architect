...
def render_bio(name, gender, prof_lemma, nat_lemma, config):
    ...
    structure = config.get('structure', "{personal_article} {name} {copula} {profession} {nationality}.")
    ...
    sentence = structure.replace("{personal_article} {name}", final_name) # Handle grouped
